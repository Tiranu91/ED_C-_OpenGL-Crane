...
{
    public partial class TView : OpenGLControl, Observable
    {
        private Observer observer;

        //TKran kran = new TKran();
        TKran kran = TKran.getInstance();
        ...
        public void drawScene()
        {
            ...
            //coordinateSystem(2);
            GL.glTranslated(0.0, 1.0, -6.0);            
            GL.glRotated(-60, 1, 0, 0);
            //coordinateSystem(0.5);
            coordinateSystem(1);
            
            //Methoden zum zeuchnen der einzelenen Elemente aufrufen
            kran.turm();
            kran.gelenk();
            kran.ausleger();
            kran.schieber();
        ...
        public void changeVal(int obj, int val)
        {
            ...
            if (obj == 2) { kran.TargetArmLength = Convert.ToDouble(val) / 10; };
            if (obj == 3) { kran.TargetRopeLength = Convert.ToDouble(val) / 10; };
